jQuery(document).ready(function(){
	...
	if (jQuery('#billing\\:tipopessoa').val() == "Pessoa Jurídica") {
		...
		if (jQuery('#isento').attr('checked')) {
			// desabilita ie
			jQuery('#billing\\:ie').val('ISENTO');
			jQuery('#billing\\:ie').attr('readonly', true);
			jQuery('#billing\\:ie').attr('disabled', true);
			jQuery('#billing\\:ie').css('background-color', '#cccccc');
	    };
    ...
    jQuery('#billing\\:tipopessoa').change(checkTipopessoa);
    ...
    var checkIsento = function()
    {
    	if(jQuery(this).attr('checked')) {
    		...
    		jQuery('#billing\\:ie').val('');
			jQuery('#billing\\:ie').removeAttr('readonly');
			jQuery('#billing\\:ie').removeAttr('disabled');
			jQuery('#billing\\:ie').css('background-color', '#FFFFFF');
    	}
    };
