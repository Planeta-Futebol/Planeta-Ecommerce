...
class Magestore_Affiliateplus_Block_Adminhtml_Account_Edit_Tab_Transaction extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    public function getGridUrl() {
        return $this->getData('grid_url') ? $this->getData('grid_url') : $this->getUrl('*/*/transactionGrid', array(
                    '_current' => true,
