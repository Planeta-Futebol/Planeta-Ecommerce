 ...
 */
class Reports_BillingCustomer_Adminhtml_BillingCustomerController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function exportCsvAction() {
        ...
        $content = $this->getLayout()->createBlock('billingcustomer/adminhtml_billingcustomer_grid')
            ->getCsv();
