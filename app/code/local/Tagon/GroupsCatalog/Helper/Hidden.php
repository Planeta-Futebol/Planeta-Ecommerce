...
class Tagon_GroupsCatalog_Helper_Hidden extends Mage_Core_Helper_Abstract
{
    /**
     ...
     * @return Tagon_GroupsCatalog_Helper_Hidden
     */
    ...
    protected function _applyHiddenEntityRedirect($entityTypeCode)
    {
        ...
        switch ($type) {
            case Tagon_GroupsCatalog_Model_System_Config_Source_HiddenEntityHandling::HIDDEN_ENTITY_HANDLING_REDIRECT:
                return $this->_applyEntityRedirectTargetRoute($targetRouteSetting);
                break;

            case Tagon_GroupsCatalog_Model_System_Config_Source_HiddenEntityHandling::HIDDEN_ENTITY_HANDLING_REDIRECT_PARENT:
     ...
     * @return Tagon_GroupsCatalog_Model_Observer
     */
