...
class Tagon_GroupsCatalog_Model_Resource_Setup extends Mage_Catalog_Model_Resource_Setup
{
    /**
    ...
    public function dropIndexTable($entityType)
    {
         ...
         */
        $tableAlias = Mage::helper('tagon_groupscatalog')
    ...
    public function createIndexTable($entityType)
    {
        ...
        $table = $this->getConnection()->newTable($tableName)
            ...
            ->setComment('GroupsCatalog ' . $entityType . ' Customer Group Index Table');
        $this->getConnection()->createTable($table);
    }

    public function addGroupsCatalogAttribute($entityType)
    {
        $attributeCode = Tagon_GroupsCatalog_Helper_Data::HIDE_GROUPS_ATTRIBUTE;
