...
class Tagon_GroupsCatalog_Model_Sitemap_Resource_Catalog_Product
    extends Mage_Sitemap_Model_Resource_Catalog_Product
{
    ...
    private function _getNotLoggedInBehavior()
    {
        if (! $this->_notLoggedInBehavior) {
            $this->_notLoggedInBehavior = Mage::getModel('tagon_groupscatalog/sitemap_resource_catalog_behavior_filterSitemapProduct');
        }
