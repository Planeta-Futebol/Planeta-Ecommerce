...
class Tagon_GroupsCatalog_Model_Sitemap_Resource_Catalog_Category
    extends Mage_Sitemap_Model_Resource_Catalog_Category
{
    /**
     * @var Tagon_GroupsCatalog_Model_Sitemap_Resource_Catalog_Behavior_FilterSitemapAbstract
     */
     ...
     * DI setter
     *
     * @param Tagon_GroupsCatalog_Model_Sitemap_Resource_Catalog_Behavior_FilterSitemapAbstract $filter
     */
    public function setAddFilterBehavior(
        Tagon_GroupsCatalog_Model_Sitemap_Resource_Catalog_Behavior_FilterSitemapAbstract $filter)
    {
     ...
     * DI getter
     *
     * @return Tagon_GroupsCatalog_Model_Sitemap_Resource_Catalog_Behavior_FilterSitemapAbstract
     */
    private function _getNotLoggedInBehavior()
    {
        if (! $this->_notLoggedInBehavior) {
            $this->_notLoggedInBehavior = Mage::getModel('tagon_groupscatalog/sitemap_resource_catalog_behavior_filterSitemapCategory');
        }
