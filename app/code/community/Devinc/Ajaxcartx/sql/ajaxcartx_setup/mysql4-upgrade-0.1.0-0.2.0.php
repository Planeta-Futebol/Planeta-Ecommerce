...
$installer->setConfigData('ajaxcartx/dragdrop/enable_category_dragdrop',  							1);
...
$installer->setConfigData('ajaxcartx/dragdrop/tooltip_cart_text',  									'BUY ME');
$installer->setConfigData('ajaxcartx/dragdrop/tooltip_compare_text',  								'COMPARE ME');
$installer->setConfigData('ajaxcartx/dragdrop/tooltip_wishlist_text',  								'WISH ME');
