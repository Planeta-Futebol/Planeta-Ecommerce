<?php
class Devinc_Ajaxcartx_Block_Product_List_New extends Mage_Catalog_Block_Product_New
{    
    protected function _construct()
    {
        $this->_productsCount = Mage::getStoreConfig('ajaxcartx/popup_configuration/product_number'); 
        parent::_construct();
    }
